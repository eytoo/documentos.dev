    ...
    <!--<script src="js/menu-pegajoso.js"></script>-->
    <!-- Owl Carousel -->
    ...
    <!--Preloader-->
    <script src="/public/frontend/plugins/preloader/js/classie.js"></script>
    <script src="/public/frontend/plugins/preloader/js/pathLoader.js"></script>
    <script src="/public/frontend/plugins/preloader/js/main.js"></script>
