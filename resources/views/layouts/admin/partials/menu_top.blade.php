  ...
  <div class="navbar-wrapper">
    <div class="navbar-header">
      <ul class="nav navbar-nav">
        ...
        <li class="nav-item"><a href="/home" class="navbar-brand nav-link"><img alt="branding logo" style="width: 232px;" src="/img/cursania.svg" data-expand="/robust-assets/images/logo/robust-logo-dark.png" data-collapse="/robust-assets/images/logo/robust-logo-small.png" class="brand-logo"></a></li>
    ...
    <div class="navbar-container content container-fluid">
      <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
        ...
        <ul class="nav navbar-nav float-xs-right">
            <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="/usuario.png" alt="avatar"><i></i></span><span class="user-name">{{ Auth::user()->name }}</span></a>
