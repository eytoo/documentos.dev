...
<div class="row">
    ...
    <script src="/robust-assets/js/plugins/editors/quill/katex.min.js" type="text/javascript"></script>
    <script src="/robust-assets/js/plugins/editors/quill/highlight.min.js" type="text/javascript"></script>
    <script src="/robust-assets/js/plugins/editors/quill/quill.min.js" type="text/javascript"></script>
    <script>
    ...
    <script src="/robust-assets/js/components/editors/editor-quill.js" type="text/javascript"></script>
