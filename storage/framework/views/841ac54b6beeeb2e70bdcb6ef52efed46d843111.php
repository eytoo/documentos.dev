    ...
    <table id="myTable" class="datatable table-white-space table table-hover card-table zero-configuration table-middle">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $dataList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                ...
                <td><a data-modal="byUrl" href="<?php echo e(route(str_slug($entity_p).".edit",[$object->id])); ?>"><?php echo e($object->name); ?></a></td>
                <td>
                    <a href="mailto:<?php echo e($object->email); ?>"><?php echo e($object->email); ?></a>
                </td>
                <td>
                    <span class="tag tag-<?php echo e($object->activo == 0?'danger':'default'); ?>"><?php echo e(getEstado($object->activo)); ?></span>
                </td>
                <td style="text-transform:capitalize;"><?php echo e($object->user_reg_modo); ?></td>
