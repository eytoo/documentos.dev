            ...
            <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <form class="form-horizontal form-simple"  role="form" method="POST" action="<?php echo e(route('login')); ?>">
                            <?php echo e(csrf_field()); ?>

                            <fieldset class="form-group has-feedback has-icon-left mb-0<?php echo e($errors->has('login') ? ' has-error' : ''); ?>">
                                <input type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="Usuario o E-mail" name="login" value="<?php echo e(old('email')); ?>" required autofocus>
                            ...
                            <fieldset class="form-group has-feedback has-icon-left<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                            ...
                            <fieldset class="form-group row">
                                <div class="col-md-6 col-xs-12 text-xs-center text-md-left">
                                    <fieldset>
                                        <input <?php echo e(old('remember') ? 'checked' : ''); ?> type="checkbox" id="remember-me" name="remember" class="chk-remember">
