                        ...
                        <div class="col-lg-2 col-md-12">
                            <div class="chart-stats text-xs-center">
                                <div class="new-users my-2 overflow-hidden clearfix">
                                    <span>Documentos/<?php echo e($mesactual); ?></span>
                        ...
                        <div class="col-md-12 col-lg-10">
                            <div class="card">
                                ...
                                <ul class="list-inline text-xs-center mt-3">
                                    <li>
                                        <h6><i class="icon-circle primary"></i> Documentos entregados (<?php echo e($usuariost); ?>)</h6>
                                    </li>
                                    <li>
                                        <h6><i class="icon-circle success pl-1"></i> Nuevos documentos (<?php echo e($conductorest); ?>)</h6>
                                    </li>
                                </ul>
                                <div class="card-body">
